...
public enum StatusCode {
    ...
    VERIFICATION_MAIL_SEND_SUCCESS(200,"S008","VERIFICATION MAIL SEND SUCCESS"),
    VERIFICATION_CODE_MATCH(200,"S009","VERIFICATION CODE MATCH"),
    ...
    MAIL_SEND_FAIL(500,"E030","UNABLE TO SEND MAIL FOR USER VERIFICATION"),
    DUPLICATE_MAIL(400, "E031","REQUESTED MAIL IS ALREADY IN USE"),
    MAIL_REQUEST_COOLDOWN(400,"E034","MAIL REQUEST COOLDOWN, PLEASE REQUEST AFTER A SHORT WAIT (1 MIN"),
    VERIFICATION_CODE_MISMATCH(400,"E032","VERIFICATION CODE MISMATCH"),
    VERIFICATION_CODE_TIMEOUT(400,"E033","VERIFICATION CODE TIMEOUT"),
